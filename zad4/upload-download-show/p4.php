...
<meta name="description"
	content="Programowanie internetowe -- Eryk Banas" />
<meta name="keywords" content="Programowanie internetowe" />
<title>Upload - Download - Show | Programowanie Internetow Lab | Eryk
	Banas</title>
<link rel="icon" type="image/x-icon" href="../../img/favicon.ico" />
<link rel="stylesheet" type="text/css" href="../../mainStyle.css" />
<link rel="stylesheet" type="text/css" href="../../purecss/forms.css" />
<!-- purecss.io -->
<link rel="stylesheet" type="text/css" href="../../purecss/buttons.css" />
<!-- purecss.io -->
<link rel="stylesheet" type="text/css" href="../../purecss/tables.css" />
<!-- purecss.io -->
</head>
<body>
	<div id="wrapper">
			...
			<article class="border-1px-solid-black padding-1em">
					...
					<div class="text-align-center">
						<div class="display-inline-block">
							...
							<form id="form" name="form" class="pure-form pure-form-aligned"
								...
								<!-- No własnie - wcale nie musimy się przez skrypt php-a odwoływać do innych plików php - musimy TYLKO, jeśli chcemy przy tym zaimplementowac jakis skrypt tego php-a do strony! -->
								<fieldset>
									...
									<div class="pure-control-group">
										...
										<!-- Powyżej wybieralismy pliki do uploadowania, natomiast tu je rzeczywiscie zatwierdzamy
                                        tutaj ten submit zatwierdza wysyłanie tego formularza! -->
									</div>
								</fieldset>
							</form>
						</div>
				...
				<section>
					<div class="text-align-center overflow-auto">
						<div class="display-inline-block">
						<?php require_once "show_uploaded.php"; ?>
							<!--Polecenie "include" zawiera i ocenia okreslony plik. "require" wywala błąd w miejscu, w którym "inlude" zawarłoby tylko warning-a (w przypadku,
                            												gdyby np. format się nie zgadzał, albo pliku w ogóle nie było - i nie pozwoli przejsc programowi dalej!).
		...
		<footer class="textAlignCenter">
			<p>Copyright &copy; Eryk Banas &bull; Strona wykonana wramach zajęć:
				Programowanie internetowe.</p>
			<p>
				<a href="http://validator.w3.org/check?uri=referer" target="_blank">
					<img src="http://www.w3.org/Icons/w3c_home.png" alt="Valid HTML 5"
